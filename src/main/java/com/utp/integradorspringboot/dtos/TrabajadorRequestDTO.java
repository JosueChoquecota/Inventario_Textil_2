...
public class TrabajadorRequestDTO {
    ...
    public TrabajadorRequestDTO(String nombres, String apellidos, Integer idTipoDoc, String nDocumento, String telefono,
            String correo, Integer idRol, String contrasena, Boolean estado) {
